...
class CustomListClone extends StatefulWidget {
  final List<Spacecraft> spacecrafts;
  final CurrDriverInfo dv;

  CustomListClone(this.spacecrafts, this.dv);

  @override
  _CustomListCloneState createState() => _CustomListCloneState();
}

class _CustomListCloneState extends State<CustomListClone> {
  ...
  Widget createViewItem(Spacecraft spacecraft, BuildContext context) {
    if (spacecraft.driverid == widget.dv.phone) {
      return new ListTile(
          title: new Card(
            elevation: 5.0,
            child: new Container(
...
Future<List<Spacecraft>> downloadJSON() async {
  final jsonEndpoint =
      "http://192.168.1.8/otobus/phpfiles/feedbacK.php"; //10.0.0.9
